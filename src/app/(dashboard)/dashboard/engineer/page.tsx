    ...
    const fetchProfile = async () => {
      try {
        if (!isFirebaseConfigured()) {
          console.warn('Firebase not configured, using mock data for engineer dashboard');
          setProfile({
            uid: 'mock-engineer-uid',
        ...
        setProfile({
          uid: 'fallback-engineer-uid',
          email: 'engineer@example.com',
          displayName: 'Engineer (Offline)',
          role: 'engineer',
...
export default withRoleProtection(EngineerDashboardPage, ['engineer']) as React.ComponentType<object>;
